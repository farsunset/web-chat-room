 ...
 ***************************************************************************************
 */
package com.farsunset.chat.mvc.response;
...
public class ResponseEntity<T> {
	...
	public static <Q> ResponseEntity<Q> make(HttpStatus status,Q data){
	...
	public static <Q> ResponseEntity<Q> make(HttpStatus status){
		ResponseEntity<Q> result = new ResponseEntity<>();
		result.setCode(status.value());
		result.setData(null);
		result.setMessage(status.getReasonPhrase());
